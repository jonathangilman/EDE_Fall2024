...
> Answer: 
I took several courses in undergrad that used both R and Git (Ex: Biostatistics, Biocomputing). I've also had decent experience with data analytics. In undergrad I completed my own research project which included collecting and analyzing all my own data. And this past year I worked as a research fellow for the EPA and my primary role was data collection and analysis.

2. Are there any components of the course about which you feel confident?

> Answer: 
I feel very confident navigating R and creating figures.

3. Are there any components of the course about which you feel apprehensive?

> Answer: 
I feel a little apprehensive when it comes to wrangling large datasets. Also, I am not the strongest at stats -- specifically determining which tests/analyses to use.
...
> Answer: 
https://github.com/jonathangilman/EDE_Fall2024.git
