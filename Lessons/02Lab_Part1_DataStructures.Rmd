...
#access first 2 elements of list (name and mynumbers)
list1[1:2]

#change the name to Janelle
list1$name = "Janelle"

#changes value of fourth element (age)
list1[[4]] = 44
```
