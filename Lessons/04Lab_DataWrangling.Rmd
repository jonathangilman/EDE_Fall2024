...
NTL.phys.data.90_99 <- filter(NTL.phys.data, (lakename == 'Tuesday Lake') & (year4 %in% c(1990:1999)))
...
> Answer: Bc what if you add in more data
...
NTL.phys.data.processed2_watertemp <- 
  NTL.phys.data.processed2 %>%
  filter(depth == 0) %>%
